...
function Footer() {
    return (
        <footer className="bg-gray-900 text-gray-200 py-6 fixed bottom-0 w-10">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-wrap justify-between items-center">
                <div className="w-full sm:w-auto mb-4 sm:mb-0">
                    <Link href="/">
                        <a className="text-lg font-bold text-white hover:text-gray-400 transition-colors duration-300">GameGenie</a>
                    </Link>
                </div>
                <div className="w-full sm:w-auto text-sm">
                    <ul className="flex flex-wrap gap-6">
                        <li>
                            <Link href="/about">
                                <a className="hover:text-gray-400 transition-colors duration-300">About</a>
                            </Link>
                        </li>
                        <li>
                            <Link href="/contact">
