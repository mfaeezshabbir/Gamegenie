/* This is a React component called `GameDetails` that displays details about a video game. It imports
various dependencies such as `axios` for making HTTP requests, `PropTypes` for type checking,
`React` for creating React components, `FontAwesomeIcon` and `faHeart` for displaying a heart icon,
`Link` for creating links to other pages, and `useRouter` for accessing the router object. It also
        ...
        <div className="bg-white rounded-lg overflow-hidden shadow-lg">
            ...
            <div className="p-4">
                ...
                <p className="text-gray-700 mb-2">
                    ...
                    {game.platformsName && game.platformsName.map((platform, index) => (
                ...
                <p className="text-gray-700 mb-2">
                    ...
                    {game.genresName && game.genresName.map((genre, index) => (
