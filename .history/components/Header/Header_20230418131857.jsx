...
function NavItem({ href, children, active }) {
    return (
        <Link href={href}>
            <div className={`text-gray-500 hover:text-gray-900 ${active ? 'text-purple-700' : ''}`}>
                {children}
            </div>
        </Link>
    );
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <nav className="flex justify-between items-center h-16">
                        ...
                        <div className="hidden md:block">
                            <div className="ml-10 flex items-baseline space-x-4 font ">
                                {links.map(link => (
                                    <NavItem
                                        key={link.href}
                                        href={link.href}
                        ...
                        <div className="-mr-2 flex md:hidden">
                            ...
                            >
                                ...
                                <svg className={`${isMenuOpen ? 'block' : 'hidden'} h-6 w-6`}
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="none"
                                    viewBox="0 0 24 24"
                                    stroke="currentColor"
