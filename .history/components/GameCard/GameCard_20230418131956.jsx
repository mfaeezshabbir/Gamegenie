...
function GameCard({ game }) {
  ...
  return (
    <div className="flex flex-col items-center w-full px-4 py-6 transition-colors duration-200 bg-gray-100 border border-gray-200 rounded-lg shadow-md hover:shadow-lg">
      <div className="relative flex items-center justify-center w-full mb-4 overflow-hidden bg-gray-200 rounded-lg w-10 h-6 transition-all duration-300 transform hover:scale-105">
        <img
