...
function GameCard({ game }) {
  ...
  const blurStyle = hovered ? "blur-lg" : "blur-none";

  return (
    <div className={`bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 ${blurStyle}`}
