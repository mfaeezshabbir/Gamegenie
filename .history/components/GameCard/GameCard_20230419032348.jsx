...
function GameCard({ game }) {
  return (
    <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 card relative">
      <div className="relative overflow-hidden bg-gray-200 hover:bg-gray-300 py-4 px-6 rounded-lg shadow-md transition duration-300">
      ...
      <div className="p-4 absolute top-full left-0 bg-gray-200 py-4 px-6 rounded-lg shadow-md transition duration-300 transform translate-y-2 opacity-0 group-hover:opacity-100">
