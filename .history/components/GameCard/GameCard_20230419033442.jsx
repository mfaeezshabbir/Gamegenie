    ...
    <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 card">
      ...
      <div className="p-4">
        <p className="text-gray-700 mb-2">
          {game.releaseDate ? (
            <>
              <span className="font-semibold {heading}">Released:</span> {game.releaseDate}
              <br />
            </>
          ) : null}
          <span className="font-semibold {heading}">Platforms:</span>{' '}
        ...
        <p className="text-gray-700 mb-2">
          <span className="font-semibold {heading}">Genres:</span>{' '}
