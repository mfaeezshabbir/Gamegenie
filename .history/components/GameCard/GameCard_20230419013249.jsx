  ...
  return (
    <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
      <div className="relative">
        ...
        <div className="absolute bottom-0 left-0 bg-gradient-to-t from-black to-transparent w-full h-20 p-4 flex  items-center">
          ...
          <div className="flex items-center">
            <FontAwesomeIcon icon={faHeartt} className="text-red-500 mr-1" />
            <p className="text-xs text-gray-300 font-roboto">{game.rating.toFixed(1)}/5</p>
          </div>
        </div>
      </div>
