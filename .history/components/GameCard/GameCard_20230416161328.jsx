        ...
        <div className="border-2 border-gray-800 rounded-md overflow-hidden shadow-md">
            ...
            <div className="px-4 py-3">
                ...
                <div className="flex items-center">
                    <svg version="1.0" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="230px" height="230px" className="" viewBox="-6.4 -6.4 76.80 76.80" enableBackground="new 0 0 64 64" xmlSpace="preserve">
