...
function GameCard({ game }) {
  return (
    <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 card">
      <div className="relative overflow-hidden transition-transform ease-in-out duration-300">
        <Link href={`/game/${game.slug}`}>
          <img
            ...
            layout="responsive"
            objectFit="cover"
            className="w-full h-56 object-cover transition-opacity duration-300 hover:scale-105"
          />
        </Link>
