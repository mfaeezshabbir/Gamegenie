...
function GameCard({ game }) {
  return (
    <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 card">
      <div className="relative overflow-hidden transition-all duration-300 hover:translate-x-4 hover:translate-y-4">
      ...
      <div className="p-4 absolute top-0 left-0 transform translate-x-full translate-y-full transition-all duration-300 hover:translate-x-0 hover:translate-y-0">
