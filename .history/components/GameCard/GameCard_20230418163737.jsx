        ...
        <div className="flex items-center justify-between mb-2">
          <div className="flex flex-wrap bg-gray-200 m-2 p-2 justify-center">
            {game.genres.map((genre, index) => (
              <span key={index} className="inline-block text-s text-gray-700 font-roboto">{genre}</span>
            ))}
          </div>
          <div className="flex flex-wrap bg-gray-200 m-2 p-2 justify-center">
            {game.platforms.map((platform, index) => (
              <span key={index} className="inline-block text-s text-gray-700 font-roboto">{platform}</span>
            ))}
          </div>
        </div>
