...
const GameCard = ({ title, imageSrc, platform, genre, rating, description }) => {
    return (
        <div className="border-2 border-gray-800 rounded-md overflow-hidden shadow-md w-1/2 m-3 ">
            <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition duration-300 ease-in-out">
                <div class="relative">
                    <Image src={imageSrc} alt={title} width='100%' class="object-cover w-full h-48 md:h-56" />
