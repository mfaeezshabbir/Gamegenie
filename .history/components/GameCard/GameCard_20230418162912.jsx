...
function GameCard({ game }) {
  ...
  return (
    <div className="bg-white relative rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between absol">
          <div className="flex items-center">
            <FontAwesomeIcon icon={faHeart} className="text-red-500 mr-1" />
