...
function GameCard({ game }) {
  ...
  return (
    <div className="flex flex-col items-center w-full px-4 py-6 transition-colors duration-200 bg-gradient-conic from-purple-700 border border-gray-200 rounded-lg shadow-md hover:shadow-lg">
